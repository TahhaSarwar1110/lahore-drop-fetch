      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden min-h-[90vh] flex items-center">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div
              className="absolute bottom-20 left-[5%] w-96 h-96 bg-secondary/10 rounded-full blur-3xl animate-pulse-soft"
            ...
            <div
              className="absolute top-48 right-[25%] w-2 h-2 bg-secondary/40 rounded-full animate-float"
              style={{ animationDelay: "0.5s" }}
            />
            <div
              className="absolute bottom-40 left-[40%] w-4 h-4 bg-accent/30 rounded-full animate-float"
              ...
              <div className="space-y-8 text-center lg:text-left">
                ...
                >
                  ...
                  <div className="trust-badge">
                    ...
                    <span>Enjoy same-day delivery in Lahore</span>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 lg:py-28">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">Delivery Pricing</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Choose the bundle that fits your needs</p>
            </div>
