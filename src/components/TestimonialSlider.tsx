...
const testimonials: Testimonial[] = [
  {
    ...
    location: "Dubai, UAE",
    rating: 5,
    text: "Tabedaar.com helped me send gifts to my family in Lahore. The photo confirmation before purchase gave me complete peace of mind. Highly recommended!",
  },
  {
    id: 2,
    name: "Ahmed Khan",
    location: "London, UK",
    rating: 5,
    text: "I've used Tabedaar.com multiple times for sending traditional clothes to my parents. Their service is reliable, fast, and the team is very responsive on WhatsApp.",
  },
  {
    id: 3,
    name: "Fatima Malik",
